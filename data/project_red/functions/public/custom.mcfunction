execute store result score @s variables run clear @s minecraft:golden_apple{CustomModelData:100} 0
...
execute if score @s variables matches 10.. if entity @e[type=minecraft:item,limit=1,distance=..5] run clear @s minecraft:golden_apple{CustomModelData:100} 10
